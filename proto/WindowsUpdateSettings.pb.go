...
func (x WindowsUpdateSettings_AutomaticUpdatesNotificationLevel) String() string {
	return proto1.EnumName(WindowsUpdateSettings_AutomaticUpdatesNotificationLevel_name, int32(x))
}
func (x *WindowsUpdateSettings_AutomaticUpdatesNotificationLevel) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(WindowsUpdateSettings_AutomaticUpdatesNotificationLevel_value, data, "WindowsUpdateSettings_AutomaticUpdatesNotificationLevel")
	if err != nil {
		return err
	}
...
func (x WindowsUpdateSettings_AutomaticUpdatesScheduledInstallationDay) String() string {
	return proto1.EnumName(WindowsUpdateSettings_AutomaticUpdatesScheduledInstallationDay_name, int32(x))
}
func (x *WindowsUpdateSettings_AutomaticUpdatesScheduledInstallationDay) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(WindowsUpdateSettings_AutomaticUpdatesScheduledInstallationDay_value, data, "WindowsUpdateSettings_AutomaticUpdatesScheduledInstallationDay")
	if err != nil {
		return err
	}
...
func (m *WindowsUpdateSettings) String() string            { return proto1.CompactTextString(m) }
...
func init() {
	proto1.RegisterType((*WindowsUpdateSettings)(nil), "WindowsUpdateSettings")
	proto1.RegisterEnum("WindowsUpdateSettings_AutomaticUpdatesNotificationLevel", WindowsUpdateSettings_AutomaticUpdatesNotificationLevel_name, WindowsUpdateSettings_AutomaticUpdatesNotificationLevel_value)
	proto1.RegisterEnum("WindowsUpdateSettings_AutomaticUpdatesScheduledInstallationDay", WindowsUpdateSettings_AutomaticUpdatesScheduledInstallationDay_name, WindowsUpdateSettings_AutomaticUpdatesScheduledInstallationDay_value)
}
