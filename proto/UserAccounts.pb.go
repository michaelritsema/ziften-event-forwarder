...
func (x UserAccounts_PrivilegeType) String() string {
	return proto1.EnumName(UserAccounts_PrivilegeType_name, int32(x))
}
func (x *UserAccounts_PrivilegeType) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(UserAccounts_PrivilegeType_value, data, "UserAccounts_PrivilegeType")
	if err != nil {
		return err
	}
...
func (m *UserAccounts) String() string            { return proto1.CompactTextString(m) }
...
func init() {
	proto1.RegisterType((*UserAccounts)(nil), "UserAccounts")
	proto1.RegisterEnum("UserAccounts_PrivilegeType", UserAccounts_PrivilegeType_name, UserAccounts_PrivilegeType_value)
}
