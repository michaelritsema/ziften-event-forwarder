...
func (x OSXNetworkConnect_ProtocolType) String() string {
	return proto1.EnumName(OSXNetworkConnect_ProtocolType_name, int32(x))
}
func (x *OSXNetworkConnect_ProtocolType) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(OSXNetworkConnect_ProtocolType_value, data, "OSXNetworkConnect_ProtocolType")
	if err != nil {
		return err
	}
...
func (x OSXNetworkConnect_StreamType) String() string {
	return proto1.EnumName(OSXNetworkConnect_StreamType_name, int32(x))
}
func (x *OSXNetworkConnect_StreamType) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(OSXNetworkConnect_StreamType_value, data, "OSXNetworkConnect_StreamType")
	if err != nil {
		return err
	}
...
func (m *OSXNetworkConnect) String() string            { return proto1.CompactTextString(m) }
...
func init() {
	proto1.RegisterType((*OSXNetworkConnect)(nil), "OSXNetworkConnect")
	proto1.RegisterEnum("OSXNetworkConnect_ProtocolType", OSXNetworkConnect_ProtocolType_name, OSXNetworkConnect_ProtocolType_value)
	proto1.RegisterEnum("OSXNetworkConnect_StreamType", OSXNetworkConnect_StreamType_name, OSXNetworkConnect_StreamType_value)
}
