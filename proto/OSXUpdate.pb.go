...
func (x OSXUpdate_UpdateOperation) String() string {
	return proto1.EnumName(OSXUpdate_UpdateOperation_name, int32(x))
}
func (x *OSXUpdate_UpdateOperation) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(OSXUpdate_UpdateOperation_value, data, "OSXUpdate_UpdateOperation")
	if err != nil {
		return err
	}
...
func (x OSXUpdate_OperationResultCode) String() string {
	return proto1.EnumName(OSXUpdate_OperationResultCode_name, int32(x))
}
func (x *OSXUpdate_OperationResultCode) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(OSXUpdate_OperationResultCode_value, data, "OSXUpdate_OperationResultCode")
	if err != nil {
		return err
	}
...
func (m *OSXUpdate) String() string            { return proto1.CompactTextString(m) }
...
func init() {
	proto1.RegisterType((*OSXUpdate)(nil), "OSXUpdate")
	proto1.RegisterEnum("OSXUpdate_UpdateOperation", OSXUpdate_UpdateOperation_name, OSXUpdate_UpdateOperation_value)
	proto1.RegisterEnum("OSXUpdate_OperationResultCode", OSXUpdate_OperationResultCode_name, OSXUpdate_OperationResultCode_value)
}
