...
func (m *OSXSystemInventoryNetworkAdapters) String() string { return proto1.CompactTextString(m) }
...
func init() {
	proto1.RegisterType((*OSXSystemInventoryNetworkAdapters)(nil), "OSXSystemInventoryNetworkAdapters")
}
