...
func (x PolicyStatus_PolicyStatusMessageType) String() string {
	return proto1.EnumName(PolicyStatus_PolicyStatusMessageType_name, int32(x))
}
func (x *PolicyStatus_PolicyStatusMessageType) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(PolicyStatus_PolicyStatusMessageType_value, data, "PolicyStatus_PolicyStatusMessageType")
	if err != nil {
		return err
	}
...
func (m *PolicyStatus) String() string            { return proto1.CompactTextString(m) }
...
func init() {
	proto1.RegisterType((*PolicyStatus)(nil), "PolicyStatus")
	proto1.RegisterEnum("PolicyStatus_PolicyStatusMessageType", PolicyStatus_PolicyStatusMessageType_name, PolicyStatus_PolicyStatusMessageType_value)
}
