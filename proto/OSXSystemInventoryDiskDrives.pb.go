...
func (m *OSXSystemInventoryDiskDrives) String() string            { return proto1.CompactTextString(m) }
...
func init() {
	proto1.RegisterType((*OSXSystemInventoryDiskDrives)(nil), "OSXSystemInventoryDiskDrives")
}
