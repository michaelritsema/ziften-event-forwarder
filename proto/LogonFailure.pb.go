...
func (x LogonFailure_LogonType) String() string {
	return proto1.EnumName(LogonFailure_LogonType_name, int32(x))
}
func (x *LogonFailure_LogonType) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(LogonFailure_LogonType_value, data, "LogonFailure_LogonType")
	if err != nil {
		return err
	}
...
func (x LogonFailure_FailureType) String() string {
	return proto1.EnumName(LogonFailure_FailureType_name, int32(x))
}
func (x *LogonFailure_FailureType) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(LogonFailure_FailureType_value, data, "LogonFailure_FailureType")
	if err != nil {
		return err
	}
...
func (m *LogonFailure) String() string            { return proto1.CompactTextString(m) }
...
func init() {
	proto1.RegisterType((*LogonFailure)(nil), "LogonFailure")
	proto1.RegisterEnum("LogonFailure_LogonType", LogonFailure_LogonType_name, LogonFailure_LogonType_value)
	proto1.RegisterEnum("LogonFailure_FailureType", LogonFailure_FailureType_name, LogonFailure_FailureType_value)
}
