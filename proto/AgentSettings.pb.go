...
func (x AgentSettings_NetworkConnectSendType) String() string {
	return proto1.EnumName(AgentSettings_NetworkConnectSendType_name, int32(x))
}
func (x *AgentSettings_NetworkConnectSendType) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(AgentSettings_NetworkConnectSendType_value, data, "AgentSettings_NetworkConnectSendType")
	if err != nil {
		return err
	}
...
func (m *AgentSettings) String() string            { return proto1.CompactTextString(m) }
...
func init() {
	proto1.RegisterType((*AgentSettings)(nil), "AgentSettings")
	proto1.RegisterEnum("AgentSettings_NetworkConnectSendType", AgentSettings_NetworkConnectSendType_name, AgentSettings_NetworkConnectSendType_value)
}
