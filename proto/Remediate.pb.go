...
func (x Remediate_Command) String() string {
	return proto1.EnumName(Remediate_Command_name, int32(x))
}
func (x *Remediate_Command) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(Remediate_Command_value, data, "Remediate_Command")
	if err != nil {
		return err
	}
...
func (x Remediate_ObjectType) String() string {
	return proto1.EnumName(Remediate_ObjectType_name, int32(x))
}
func (x *Remediate_ObjectType) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(Remediate_ObjectType_value, data, "Remediate_ObjectType")
	if err != nil {
		return err
	}
...
func (m *Remediate) String() string            { return proto1.CompactTextString(m) }
...
func init() {
	proto1.RegisterType((*Remediate)(nil), "Remediate")
	proto1.RegisterEnum("Remediate_Command", Remediate_Command_name, Remediate_Command_value)
	proto1.RegisterEnum("Remediate_ObjectType", Remediate_ObjectType_name, Remediate_ObjectType_value)
}
