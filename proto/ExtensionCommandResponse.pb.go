...
func (x ExtensionCommandResponse_ExtensionCommandType) String() string {
	return proto1.EnumName(ExtensionCommandResponse_ExtensionCommandType_name, int32(x))
}
func (x *ExtensionCommandResponse_ExtensionCommandType) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(ExtensionCommandResponse_ExtensionCommandType_value, data, "ExtensionCommandResponse_ExtensionCommandType")
	if err != nil {
		return err
	}
...
func (x ExtensionCommandResponse_ExtensionCommandResponseResult) String() string {
	return proto1.EnumName(ExtensionCommandResponse_ExtensionCommandResponseResult_name, int32(x))
}
func (x *ExtensionCommandResponse_ExtensionCommandResponseResult) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(ExtensionCommandResponse_ExtensionCommandResponseResult_value, data, "ExtensionCommandResponse_ExtensionCommandResponseResult")
	if err != nil {
		return err
	}
...
func (m *ExtensionCommandResponse) String() string            { return proto1.CompactTextString(m) }
...
func init() {
	proto1.RegisterType((*ExtensionCommandResponse)(nil), "ExtensionCommandResponse")
	proto1.RegisterEnum("ExtensionCommandResponse_ExtensionCommandType", ExtensionCommandResponse_ExtensionCommandType_name, ExtensionCommandResponse_ExtensionCommandType_value)
	proto1.RegisterEnum("ExtensionCommandResponse_ExtensionCommandResponseResult", ExtensionCommandResponse_ExtensionCommandResponseResult_name, ExtensionCommandResponse_ExtensionCommandResponseResult_value)
}
