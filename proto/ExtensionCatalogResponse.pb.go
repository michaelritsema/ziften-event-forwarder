...
func (x ExtensionCatalogResponse_ExtensionState) String() string {
	return proto1.EnumName(ExtensionCatalogResponse_ExtensionState_name, int32(x))
}
func (x *ExtensionCatalogResponse_ExtensionState) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(ExtensionCatalogResponse_ExtensionState_value, data, "ExtensionCatalogResponse_ExtensionState")
	if err != nil {
		return err
	}
...
func (x ExtensionCatalogResponse_RunHosting) String() string {
	return proto1.EnumName(ExtensionCatalogResponse_RunHosting_name, int32(x))
}
func (x *ExtensionCatalogResponse_RunHosting) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(ExtensionCatalogResponse_RunHosting_value, data, "ExtensionCatalogResponse_RunHosting")
	if err != nil {
		return err
	}
...
func (x ExtensionCatalogResponse_RunLifetime) String() string {
	return proto1.EnumName(ExtensionCatalogResponse_RunLifetime_name, int32(x))
}
func (x *ExtensionCatalogResponse_RunLifetime) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(ExtensionCatalogResponse_RunLifetime_value, data, "ExtensionCatalogResponse_RunLifetime")
	if err != nil {
		return err
	}
...
func (x ExtensionCatalogResponse_RunType) String() string {
	return proto1.EnumName(ExtensionCatalogResponse_RunType_name, int32(x))
}
func (x *ExtensionCatalogResponse_RunType) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(ExtensionCatalogResponse_RunType_value, data, "ExtensionCatalogResponse_RunType")
	if err != nil {
		return err
	}
...
func (m *ExtensionCatalogResponse) String() string            { return proto1.CompactTextString(m) }
...
func init() {
	proto1.RegisterType((*ExtensionCatalogResponse)(nil), "ExtensionCatalogResponse")
	proto1.RegisterEnum("ExtensionCatalogResponse_ExtensionState", ExtensionCatalogResponse_ExtensionState_name, ExtensionCatalogResponse_ExtensionState_value)
	proto1.RegisterEnum("ExtensionCatalogResponse_RunHosting", ExtensionCatalogResponse_RunHosting_name, ExtensionCatalogResponse_RunHosting_value)
	proto1.RegisterEnum("ExtensionCatalogResponse_RunLifetime", ExtensionCatalogResponse_RunLifetime_name, ExtensionCatalogResponse_RunLifetime_value)
	proto1.RegisterEnum("ExtensionCatalogResponse_RunType", ExtensionCatalogResponse_RunType_name, ExtensionCatalogResponse_RunType_value)
}
