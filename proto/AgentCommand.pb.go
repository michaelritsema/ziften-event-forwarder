...
func (x AgentCommand_CommandType) String() string {
	return proto1.EnumName(AgentCommand_CommandType_name, int32(x))
}
func (x *AgentCommand_CommandType) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(AgentCommand_CommandType_value, data, "AgentCommand_CommandType")
	if err != nil {
		return err
	}
...
func (m *AgentCommand) String() string            { return proto1.CompactTextString(m) }
...
func init() {
	proto1.RegisterType((*AgentCommand)(nil), "AgentCommand")
	proto1.RegisterEnum("AgentCommand_CommandType", AgentCommand_CommandType_name, AgentCommand_CommandType_value)
}
