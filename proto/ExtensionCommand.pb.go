...
func (x ExtensionCommand_ExtensionCommandType) String() string {
	return proto1.EnumName(ExtensionCommand_ExtensionCommandType_name, int32(x))
}
func (x *ExtensionCommand_ExtensionCommandType) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(ExtensionCommand_ExtensionCommandType_value, data, "ExtensionCommand_ExtensionCommandType")
	if err != nil {
		return err
	}
...
func (x ExtensionCommand_ExtensionType) String() string {
	return proto1.EnumName(ExtensionCommand_ExtensionType_name, int32(x))
}
func (x *ExtensionCommand_ExtensionType) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(ExtensionCommand_ExtensionType_value, data, "ExtensionCommand_ExtensionType")
	if err != nil {
		return err
	}
...
func (x ExtensionCommand_RunHosting) String() string {
	return proto1.EnumName(ExtensionCommand_RunHosting_name, int32(x))
}
func (x *ExtensionCommand_RunHosting) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(ExtensionCommand_RunHosting_value, data, "ExtensionCommand_RunHosting")
	if err != nil {
		return err
	}
...
func (x ExtensionCommand_RunLifetime) String() string {
	return proto1.EnumName(ExtensionCommand_RunLifetime_name, int32(x))
}
func (x *ExtensionCommand_RunLifetime) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(ExtensionCommand_RunLifetime_value, data, "ExtensionCommand_RunLifetime")
	if err != nil {
		return err
	}
...
func (x ExtensionCommand_RunType) String() string {
	return proto1.EnumName(ExtensionCommand_RunType_name, int32(x))
}
func (x *ExtensionCommand_RunType) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(ExtensionCommand_RunType_value, data, "ExtensionCommand_RunType")
	if err != nil {
		return err
	}
...
func (m *ExtensionCommand) String() string            { return proto1.CompactTextString(m) }
...
func init() {
	proto1.RegisterType((*ExtensionCommand)(nil), "ExtensionCommand")
	proto1.RegisterEnum("ExtensionCommand_ExtensionCommandType", ExtensionCommand_ExtensionCommandType_name, ExtensionCommand_ExtensionCommandType_value)
	proto1.RegisterEnum("ExtensionCommand_ExtensionType", ExtensionCommand_ExtensionType_name, ExtensionCommand_ExtensionType_value)
	proto1.RegisterEnum("ExtensionCommand_RunHosting", ExtensionCommand_RunHosting_name, ExtensionCommand_RunHosting_value)
	proto1.RegisterEnum("ExtensionCommand_RunLifetime", ExtensionCommand_RunLifetime_name, ExtensionCommand_RunLifetime_value)
	proto1.RegisterEnum("ExtensionCommand_RunType", ExtensionCommand_RunType_name, ExtensionCommand_RunType_value)
}
