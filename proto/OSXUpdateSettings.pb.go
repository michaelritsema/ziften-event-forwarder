...
func (x OSXUpdateSettings_AutomaticUpdatesNotificationLevel) String() string {
	return proto1.EnumName(OSXUpdateSettings_AutomaticUpdatesNotificationLevel_name, int32(x))
}
func (x *OSXUpdateSettings_AutomaticUpdatesNotificationLevel) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(OSXUpdateSettings_AutomaticUpdatesNotificationLevel_value, data, "OSXUpdateSettings_AutomaticUpdatesNotificationLevel")
	if err != nil {
		return err
	}
...
func (x OSXUpdateSettings_AutomaticUpdatesScheduledInstallationDay) String() string {
	return proto1.EnumName(OSXUpdateSettings_AutomaticUpdatesScheduledInstallationDay_name, int32(x))
}
func (x *OSXUpdateSettings_AutomaticUpdatesScheduledInstallationDay) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(OSXUpdateSettings_AutomaticUpdatesScheduledInstallationDay_value, data, "OSXUpdateSettings_AutomaticUpdatesScheduledInstallationDay")
	if err != nil {
		return err
	}
...
func (m *OSXUpdateSettings) String() string            { return proto1.CompactTextString(m) }
...
func init() {
	proto1.RegisterType((*OSXUpdateSettings)(nil), "OSXUpdateSettings")
	proto1.RegisterEnum("OSXUpdateSettings_AutomaticUpdatesNotificationLevel", OSXUpdateSettings_AutomaticUpdatesNotificationLevel_name, OSXUpdateSettings_AutomaticUpdatesNotificationLevel_value)
	proto1.RegisterEnum("OSXUpdateSettings_AutomaticUpdatesScheduledInstallationDay", OSXUpdateSettings_AutomaticUpdatesScheduledInstallationDay_name, OSXUpdateSettings_AutomaticUpdatesScheduledInstallationDay_value)
}
