...
func (x Policy_RunRuleFlag) String() string {
	return proto.EnumName(Policy_RunRuleFlag_name, int32(x))
}
func (x *Policy_RunRuleFlag) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(Policy_RunRuleFlag_value, data, "Policy_RunRuleFlag")
	if err != nil {
		return err
	}
...
func (x Policy_PolicyFlags) String() string {
	return proto.EnumName(Policy_PolicyFlags_name, int32(x))
}
func (x *Policy_PolicyFlags) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(Policy_PolicyFlags_value, data, "Policy_PolicyFlags")
	if err != nil {
		return err
	}
...
func init() {
	...
	proto.RegisterEnum("Policy_RunRuleFlag", Policy_RunRuleFlag_name, Policy_RunRuleFlag_value)
	proto.RegisterEnum("Policy_PolicyFlags", Policy_PolicyFlags_name, Policy_PolicyFlags_value)
}
