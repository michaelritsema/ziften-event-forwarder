...
func (m *OSXSystemInventoryLogicalDisks) String() string            { return proto.CompactTextString(m) }
...
func init() {
	proto.RegisterType((*OSXSystemInventoryLogicalDisks)(nil), "OSXSystemInventoryLogicalDisks")
}
