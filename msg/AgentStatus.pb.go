...
func (x AgentStatus_AgentStatusMessageType) String() string {
	return proto.EnumName(AgentStatus_AgentStatusMessageType_name, int32(x))
}
func (x *AgentStatus_AgentStatusMessageType) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(AgentStatus_AgentStatusMessageType_value, data, "AgentStatus_AgentStatusMessageType")
	if err != nil {
		return err
	}
...
func init() {
	proto.RegisterType((*AgentStatus)(nil), "AgentStatus")
	proto.RegisterEnum("AgentStatus_AgentStatusMessageType", AgentStatus_AgentStatusMessageType_name, AgentStatus_AgentStatusMessageType_value)
}
