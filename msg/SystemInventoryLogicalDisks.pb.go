...
func (m *SystemInventoryLogicalDisks) String() string            { return proto.CompactTextString(m) }
...
func init() {
	proto.RegisterType((*SystemInventoryLogicalDisks)(nil), "SystemInventoryLogicalDisks")
}
