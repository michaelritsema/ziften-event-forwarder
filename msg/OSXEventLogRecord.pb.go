...
func (x OSXEventLogRecord_EventType) String() string {
	return proto.EnumName(OSXEventLogRecord_EventType_name, int32(x))
}
func (x *OSXEventLogRecord_EventType) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(OSXEventLogRecord_EventType_value, data, "OSXEventLogRecord_EventType")
	if err != nil {
		return err
	}
...
func (m *OSXEventLogRecord) String() string            { return proto.CompactTextString(m) }
...
func init() {
	proto.RegisterType((*OSXEventLogRecord)(nil), "OSXEventLogRecord")
	proto.RegisterEnum("OSXEventLogRecord_EventType", OSXEventLogRecord_EventType_name, OSXEventLogRecord_EventType_value)
}
