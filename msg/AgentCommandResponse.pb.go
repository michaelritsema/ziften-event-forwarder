...
func (x AgentCommandResponse_CommandResult) String() string {
	return proto.EnumName(AgentCommandResponse_CommandResult_name, int32(x))
}
func (x *AgentCommandResponse_CommandResult) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(AgentCommandResponse_CommandResult_value, data, "AgentCommandResponse_CommandResult")
	if err != nil {
		return err
	}
...
func (x AgentCommandResponse_FailureCode) String() string {
	return proto.EnumName(AgentCommandResponse_FailureCode_name, int32(x))
}
func (x *AgentCommandResponse_FailureCode) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(AgentCommandResponse_FailureCode_value, data, "AgentCommandResponse_FailureCode")
	if err != nil {
		return err
	}
...
func (m *AgentCommandResponse) String() string            { return proto.CompactTextString(m) }
...
func init() {
	proto.RegisterType((*AgentCommandResponse)(nil), "AgentCommandResponse")
	proto.RegisterEnum("AgentCommandResponse_CommandResult", AgentCommandResponse_CommandResult_name, AgentCommandResponse_CommandResult_value)
	proto.RegisterEnum("AgentCommandResponse_FailureCode", AgentCommandResponse_FailureCode_name, AgentCommandResponse_FailureCode_value)
}
