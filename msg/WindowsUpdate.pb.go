...
func (x WindowsUpdate_UpdateOperation) String() string {
	return proto.EnumName(WindowsUpdate_UpdateOperation_name, int32(x))
}
func (x *WindowsUpdate_UpdateOperation) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(WindowsUpdate_UpdateOperation_value, data, "WindowsUpdate_UpdateOperation")
	if err != nil {
		return err
	}
...
func (x WindowsUpdate_OperationResultCode) String() string {
	return proto.EnumName(WindowsUpdate_OperationResultCode_name, int32(x))
}
func (x *WindowsUpdate_OperationResultCode) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(WindowsUpdate_OperationResultCode_value, data, "WindowsUpdate_OperationResultCode")
	if err != nil {
		return err
	}
...
func (m *WindowsUpdate) String() string            { return proto.CompactTextString(m) }
...
func init() {
	proto.RegisterType((*WindowsUpdate)(nil), "WindowsUpdate")
	proto.RegisterEnum("WindowsUpdate_UpdateOperation", WindowsUpdate_UpdateOperation_name, WindowsUpdate_UpdateOperation_value)
	proto.RegisterEnum("WindowsUpdate_OperationResultCode", WindowsUpdate_OperationResultCode_name, WindowsUpdate_OperationResultCode_value)
}
