...
func (x OSXPolicyStatus_PolicyStatusMessageType) String() string {
	return proto.EnumName(OSXPolicyStatus_PolicyStatusMessageType_name, int32(x))
}
func (x *OSXPolicyStatus_PolicyStatusMessageType) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(OSXPolicyStatus_PolicyStatusMessageType_value, data, "OSXPolicyStatus_PolicyStatusMessageType")
	if err != nil {
		return err
	}
...
func (m *OSXPolicyStatus) String() string            { return proto.CompactTextString(m) }
...
func init() {
	proto.RegisterType((*OSXPolicyStatus)(nil), "OSXPolicyStatus")
	proto.RegisterEnum("OSXPolicyStatus_PolicyStatusMessageType", OSXPolicyStatus_PolicyStatusMessageType_name, OSXPolicyStatus_PolicyStatusMessageType_value)
}
